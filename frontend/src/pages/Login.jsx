...
export default function Login() {
  ...
  return (
    <div className="auth-page">
      ...
      <motion.div className="auth-card glass glow-strong" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '14px', marginTop: 24, fontSize: 15 }} disabled={loading}>
            ...
            {isLogin ? 'Sign In to ZSport' : 'Create Free Account'}
          </button>
        </form>
      ...
      <style>{`
        .auth-page { min-height: 100vh; display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden; background: #0A0A0A; padding: 20px; }
        ...
        .auth-card { width: 100%; max-width: 420px; padding: 36px; border-radius: 16px; z-index: 10; background: #111111; border: 1px solid rgba(255,255,255,0.07); }
        .auth-tabs { display: flex; background: rgba(0,0,0,0.5); border-radius: 12px; padding: 4px; margin-bottom: 28px; }
        ...
        .auth-tab.active { background: #1A1A2E; color: var(--primary-dim); border: 1px solid rgba(0,219,233,0.2); }
